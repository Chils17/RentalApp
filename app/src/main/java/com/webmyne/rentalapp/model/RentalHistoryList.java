...
public class RentalHistoryList implements Serializable{

    private int  bookImage;
    private String bookName, bookPrice, bookAuthor, bookCategories, bookDeliverTime;


    public RentalHistoryList(int bookImage, String bookName, String bookPrice, String bookAuthor, String bookCategories, String bookDeliverTime) {

...
public class ShippingAddressFragment extends Fragment {
    ...
    private void init(View itemView) {
        ...
        tvlabeladdress.setText(getResources().getString(R.string.shipping_address));
        edtaddressshippingbilling.setHint(getResources().getString(R.string.hint_enter_shipping_address));
    }
}

...
public class FeaturedBooksRecyclerAdapter extends RecyclerView.Adapter<FeaturedBooksRecyclerAdapter.ViewHolder> {
    private Context mContext;
    public ViewHolder viewHolder;
    public int lastPosition = -1;

    public FeaturedBooksRecyclerAdapter(BaseActivity baseactivity) {
